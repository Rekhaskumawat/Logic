...
//                along with its name and size of each file
...
class program58_2
{
    public static void main(String A[]) throws Exception
    {
        ...
        fileobj = new File("MarvellousXXX.txt");
        ...
        for(iCnt = 0; iCnt <fArr.length ; iCnt++)
        {
            ...
            Header = "FileName :"+ fArr[iCnt].getName() + "       Size : "+fArr[iCnt].length();
            for(i = Header.length() ; i <50 ; i++)
            {
                Header = Header+ " ";
            }
            bheader = Header.getBytes();
            foobj.write(bheader ,0 ,50);
